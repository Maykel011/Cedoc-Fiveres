        ...
        <div id="editUserModal" class="modal">
            <div class="modal-content">
                ...
                <form id="editUserForm">
                    ...
                    <!-- In the Edit User Modal, modify the Designation section -->
    <div class="designation-container">
        <div class="container-header">
            <h3>Designation</h3>
        </div>
        ...
        <!-- Remove the Save Designation button for Admin users (handled in JS) -->
        <button type="button" class="btn save-container" data-container="designation" id="saveDesignationBtn">Save Designation</button>
    </div>
