document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("saveNotes").addEventListener("click", function() {
        ...
        fetch('../userBackEnd/UserInternResumeBE.php?action=updateStatus', {
            method: 'POST',
            headers: {
    ...
    Array.from(viewDocumentsBtns).forEach(button => {
        button.addEventListener("click", function() {
            ...
            fetch(`../userBackEnd/UserInternResumeBE.php?action=getApplicantData&id=${currentApplicantId}`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
    ...
    document.getElementById("confirmDelete").addEventListener("click", function() {
        fetch('../userBackEnd/UserInternResumeBE.php?action=delete', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
            },
